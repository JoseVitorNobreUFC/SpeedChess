...
public class Rook extends ChessPiece{
   ...
   * @param rowDirection direção da linha	-1 para cima, 1 para baixo, 0 não aplica
   * @param columnDirection direção da coluna -1 para esquerda, 1 para direita, 0 não aplica
